...
import navData from "../../api/navberData.json";
const Header = () => {
  return (
    <header className="pt-7.25 pb-6.75">
      <nav>
        <div className="container">
          <div className="flex">
            ...
            <ul className="ml-14 flex gap-10.75 cursor-pointer">
              {navData?.map((item) => (
                <li
                  className="text-primary after:content[''] after:bg-primary relative text-sm leading-6 font-medium after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 after:duration-500 hover:after:w-full"
                  key={item.id}
                >
                  {item?.title}
                </li>
            ...
            <div className="ml-auto flex gap-8">
              ...
              <button className="cursor-pointer relative">
                <span className="font-jost font-medium text-[10px] text-white text-center bg-notify w-4 h-4 absolute bottom-0 left-[14.02px] rounded-full">3</span>
                <svg
                  width="21"
                  height="20"
                  viewBox="0 0 21 20"
